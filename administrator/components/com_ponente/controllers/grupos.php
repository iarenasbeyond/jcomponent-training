...
/**
 * Grupos list controller class.
 *
 * @since  1.6
 */
class PonenteControllerGrupos extends JControllerAdmin
{
	/**
	 * Method to clone existing Grupos
	 *
	 * @return void
	 */
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_ponente&view=grupos');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'grupo', $prefix = 'PonenteModel', $config = array())
	{
