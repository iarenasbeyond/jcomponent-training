 ...
 * @since  1.6
 */
class PonenteModelGrupos extends JModelList
{
	/**
	 * Constructor.
	 *
...
if (empty($list['direction']))
{
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__ponente_grupo` AS a');
		...
		if ($filter_estilo != '') {
			$query->where("a.estilo = '".$db->escape($filter_estilo)."'");
		}
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
					...
					$item->estilo = JText::_('COM_PONENTE_GRUPOS_ESTILO_OPTION_' . strtoupper($item->estilo));
		}
