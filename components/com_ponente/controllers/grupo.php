 ...
 * @since  1.6
 */
class PonenteControllerGrupo extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Grupo', 'PonenteModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_ponente') || $user->authorise('core.edit.state', 'com_ponente'))
		{
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_ponente&view=grupos', false));
			}
			else
			{
