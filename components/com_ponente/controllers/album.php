 ...
 * @since  1.6
 */
class PonenteControllerAlbum extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Album', 'PonenteModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_ponente') || $user->authorise('core.edit.state', 'com_ponente'))
		{
			$model = $this->getModel('Album', 'PonenteModel');
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_ponente&view=albums', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_ponente'))
		{
			$model = $this->getModel('Album', 'PonenteModel');
